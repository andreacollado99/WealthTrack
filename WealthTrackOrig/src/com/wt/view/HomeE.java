...
public class HomeE extends JFrame {
    ...
    public static final String ACT_COM_BTN_TRANSACCIONES = "TRANSACCIONES";
    ...
    private void initComponents() {
        ...
        btnTransacciones = new JButton(ACT_COM_BTN_TRANSACCIONES);
        btnTransacciones.setBounds(564, 0, 286, 47);
        btnTransacciones.setFont(new Font("Tahoma", Font.PLAIN, 16));
        pnlBotones.add(btnTransacciones);
    ...
    public void setControlador(ControlLogin cl) {
        ...
        btnTransacciones.addActionListener(cl);
